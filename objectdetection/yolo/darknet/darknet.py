...
def draw_boxes(detections, image_ori, image_resized, colors):
    import cv2
    #calculate orignal image and resized images
    x_rate = image_ori.shape[1] / image_resized.shape[1]
    y_rate = image_ori.shape[0] / image_resized.shape[0]
