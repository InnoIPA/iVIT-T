...
def convert_unet(input_model:str, output_dir:str, model_name:str, export_dir:str, 
    ...
    command = "mo --framework=tf --data_type=FP16 --input_model {} --output_dir {} --input_shape [1,{},{},{}] \
                        --mean_values=[127.5,127.5,127.5] --scale_values=[127.5,127.5,127.5]".format(ROOT + split_output_model[-1], 
