...
def convert_unet(input_model:str, output_dir:str, export_dir:str, project_name:str, model_dict:dict, cfg_path:str, shape:list):
    ...
    hailo = Hailo(project_name, output_model, "segmentation", shape)
    start_node = ["import/data"]
    end_node = ["import/softmax/Softmax"]
