...
from webapi.common import init_db, init_sample_to_db, init_color_table_db, \
                            ...
                            update_version_function, read_json, write_json, Schedule
                                          
from webapi.common.config import *
from webapi.common.config import SCHEDULE
import time
def build_argparser():
...
def main(args):
    ...
    logging.info("Start training schedule...")
    test_schedule = Schedule()
    app.config["SCHEDULE"] = test_schedule
    test_schedule.start()
